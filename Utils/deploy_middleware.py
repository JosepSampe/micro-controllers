...
os.system('sshpass -p %s scp -r %s %s@%s:%s' % (password, '../Engine/runtime/utils/start_daemon.sh', user, host, '/opt/vertigo'))
os.system('sshpass -p %s scp -r %s %s@%s:%s' % (password, '../Engine/bus/DockerJavaFacade/bin/BusDockerJavaFacade.jar', user, host, '/opt/vertigo'))
os.system('sshpass -p %s scp -r %s %s@%s:%s' % (password, '../Engine/bus/DockerJavaFacade/bin/libjbus.so', user, host, '/opt/vertigo'))
os.system('sshpass -p %s scp -r %s %s@%s:%s' % (password, '../Engine/bus/TransportLayer/bin/bus.so', user, host, '/opt/vertigo'))
