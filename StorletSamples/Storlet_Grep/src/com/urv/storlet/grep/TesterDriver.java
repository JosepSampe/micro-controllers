...
public class TesterDriver {
	...
	public static final String INPUT_FILE_NAME = "input/adult.data";
	public static final String OUTPUT_FILE_NAME = "input/adult.data.filtered";
	...
	public static void main(String[] args) {
		...
		try {
			...
			GrepStorlet storlet = new GrepStorlet();	
			StorletLogger logger = new StorletLogger(loggerFile.getFD());				
			Map<String, String> parameters = new HashMap<String, String>();	

			parameters.put("regexp","675148549");
