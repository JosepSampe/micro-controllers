...
public class TesterDriver {
	...
	public static final String INPUT_FILE_NAME = "input/paper.gz";
	public static final String OUTPUT_FILE_NAME = "input/paper.pdf";
	...
	public static void main(String[] args) {
		...
		try {
			...
			CompressStorlet storlet = new CompressStorlet();	
			StorletLogger logger = new StorletLogger(loggerFile.getFD());				
			Map<String, String> parameters = new HashMap<String, String>();	

			parameters.put("compression","gz");
